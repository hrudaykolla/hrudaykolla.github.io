...
Home_page = st.Page(home_page, title="Profile", icon="👤", default=True, url_path="profile")
education_page = st.Page(education_page, title="Education", icon="🎓", url_path="education")
personal_projects_page = st.Page(personal_projects_page, title="Personal Projects", icon="💻", url_path="personal_projects")
professional_experience_page = st.Page(professional_experience_page, title="Professional Experience", icon="💼", url_path="professional_experience")
